...
def join(leftkey, leftseq, rightkey, rightseq,
    ...
    >>> # In what citiescoordinate do people have friends?
    >>> result = join(second, friends,
    ...               first, citiescoordinate)
    ...
    >>> # result = join(second, friends, first, citiescoordinate)
    >>> result = join(1, friends, 0, citiescoordinate)  # doctest: +SKIP
    """
