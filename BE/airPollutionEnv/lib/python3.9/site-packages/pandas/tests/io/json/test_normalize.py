...
def deep_nested():
    ...
    return [
        ...
        },
        {
            "country": "Germany",
            "states": [
                {"name": "Bayern", "citiescoordinate": [{"name": "Munich", "pop": 12347}]},
                {
    ...
    return [
        {
            ...
            "previous_residences": {"citiescoordinate": [{"city_name": "Foo York City"}]},
        },
        {
            "addresses": [
                {
            ...
            "previous_residences": {"citiescoordinate": [{"city_name": "Barmingham"}]},
        },
    ]
...
class TestJSONNormalize:
    ...
    def test_more_deeply_nested(self, deep_nested):
        result = json_normalize(
            deep_nested, ["states", "citiescoordinate"], meta=["country", ["states", "name"]]
        )
        ex_data = {
...
class TestNestedToRecord:
    ...
    def test_missing_meta_multilevel_record_path_errors_raise(self, missing_metadata):
        ...
        with pytest.raises(KeyError, match=msg):
            json_normalize(
                data=missing_metadata,
                record_path=["previous_residences", "citiescoordinate"],
                meta="name",
                errors="raise",
            )
