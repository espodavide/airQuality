...
class TestExplore:
    def setup_method(self):
        ...
        self.citiescoordinate = gpd.read_file(gpd.datasets.get_path("naturalearth_cities"))
    ...
    def test_default_markers(self):
        ...
        m = self.citiescoordinate.explore()
        strings = ['"radius":2', '"fill":true', "CircleMarker(latlng,opts)"]
        out_str = self._fetch_map_string(m)
        for s in strings:
            assert s in out_str

        m = self.citiescoordinate.explore(marker_kwds={"radius": 5, "fill": False})
    ...
    def test_custom_markers(self):
        ...
        # Circle Markers
        m = self.citiescoordinate.explore(marker_type="circle", marker_kwds={"fill_color": "red"})
        ...
        # Circle
        m = self.citiescoordinate.explore(marker_type="circle_marker", marker_kwds={"radius": 10})
        ...
        with pytest.raises(
            ...
            self.citiescoordinate.explore(marker_type="dummy")
